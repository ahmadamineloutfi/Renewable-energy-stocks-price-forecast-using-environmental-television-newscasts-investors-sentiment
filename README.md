...
1. Target variable: The daily adjusted stock prices of RE firms were collected from Yahoo Finance, between July 2nd, 2009, and January 21st, 2021. They include RE firms listed in the WilderHill Clean Energy Index (ECO), which is widely used as a benchmark for clean energy stocks 
...
2.2. Spoken Environmental TV newscasts is available on Kaggle (Singh, 2020). It was collected from the four major US TV newscasts channels: CNN, BBC News, MSNBC, and Fox News, It contains a total of 92800 rows of text that maps to the period between July 2nd, 2009, to January 21st, 2021. It is also available in a zip file titled: "NLP.zip". 
