...
2.2. Spoken Environmental TV newscasts dataset is available on Kaggle (Singh, 2020). Spoken dataset was collected from the four major US TV newscasts channels: CNN, BBC News, MSNBC, and Fox News making a total of 92800 rows of text that maps to the period between July 2nd, 2009, to January 21st, 2021. The dataset is also available in this depository in a zip file titled: "NLP.zip". We recommend importing the data directly from this depository, because using the data stored in the original zip file published in Kaggle, requires deleting a csv file that stops the importation of the data.
